/**
 * نظام إدارة الموارد البشرية السحابي - تحديث عرض الحقول الديناميكية
 * 
 * هذا الملف يحتوي على تحديثات لعرض جميع الحقول الرئيسية والديناميكية من Google Sheets
 */

// تحديث دالة تحديث جدول الموظفين لعرض جميع الحقول الديناميكية
...
// تحديث دالة عرض تفاصيل موظف لعرض جميع الحقول
...
// تحديث دالة فتح نموذج إضافة/تعديل موظف لدعم الحقول الديناميكية
...
// تحديث دالة حفظ بيانات الموظف لدعم الحقول الديناميكية
...
// تحديث دالة جلب البيانات لمعالجة أخطاء الاتصال بشكل أفضل
HR.fetchData = function() {
  // عرض مؤشر التحميل
  HR.showLoading();
  
  // التحقق من وجود رابط Google Apps Script
  if (!HR.SCRIPT_URL || HR.SCRIPT_URL === 'https://script.google.com/macros/
